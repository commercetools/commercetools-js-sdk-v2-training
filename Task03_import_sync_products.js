...
// checkImportOperationStatusById("2ced4095-0629-4af0-be47-db9b1b8b06bc").then(log).catch(log);
// checkImportOperationStatusById("bb132db2-7747-4175-b33f-9780bc16e178").then(log).catch(log);
